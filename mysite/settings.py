...
SECRET_KEY = 'django-insecure-!r%l5%i-hgg@rolw*2=^-sa+)yb-q-i__$-p%&a-%i75njn5y$'
...
INSTALLED_APPS = [
    ...
    'taggit',# third party
    'django.contrib.sites', #django local
    'django.contrib.sitemaps', #django local
...
ROOT_URLCONF = 'mysite.urls' # where django should serve your urls
